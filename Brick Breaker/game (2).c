...
// Start message
char startGameMessage[] = "Press return to begin!";
char promptStartPlayingMessage[] = "Press L to launch the ball!";
char gameOverMessage[] = "Press L or return to play again!";
...
const u16 colors[] = {RED, GREEN, WHITE,};
...
int main() {
	...
	void drawGameStage() {
		drawRect(0, 0, GBA_HEIGHT, GBA_WIDTH, BLACK); 
